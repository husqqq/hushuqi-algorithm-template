...
本仓库保存作者持续维护的算法竞赛模板、当前模板生成的 Library Checker 解答，以及用于交叉核对的参考实现和网络资料。主模板采用 C++20，正文含第 0–15 章，其中第 1–14 章共 671 个算法知识点，第 0 章为比赛检查清单，第 15 章为题面英文词表，并同步维护性能优先头文件、打印版头文件、测试与 PDF 合订本。
