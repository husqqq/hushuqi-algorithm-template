...
vector<Z> powerProjection(const Poly &f, const vector<Z> &w, int m)
{
...
namespace lagrange
{
int lagrangeCoeff(vector<int> phi, int n)
{
...
Poly compositionalInverse(const Poly &f, int n)
{
    ...
    vector<Z> w(d + 1);
    w[d] = 1;
    auto c = powerProjection(h, w, d + 1);
...
signed main()
{
    ...
    printPoly(compositionalInverse(f, n));
    return 0;
}
