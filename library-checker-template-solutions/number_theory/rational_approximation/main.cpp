...
pair<pair<long long, long long>, pair<long long, long long>>
sternChildren(long long p, long long q)
{
    auto path = sternPath(p, q);
    return {sternDecode(path, 1, 2), sternDecode(path, 2, 1)};
}

optional<pair<long long, long long>> sternAncestor(long long k, long long p,
                                                   long long q)
{
    auto path = sternPath(p, q);
...
pair<pair<long long, long long>, pair<long long, long long>>
rationalApproximation(long long n, long long x, long long y)
{
