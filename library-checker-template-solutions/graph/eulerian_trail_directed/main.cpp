...
optional<EulerTrail> directedEuler(int n, const vector<pair<int, int>> &edges, bool lex = false)
{
...
optional<EulerTrail> undirectedEuler(int n, const vector<pair<int, int>> &edges, bool lex = false)
{
