...
optional<DirectedMSTResult> directedMSTTree(int n, int root, const vector<DirectedMSTFastEdge> &e)
{
    ...
    parent[root] = root;
    return DirectedMSTResult{sum, parent};
}
