...
这是一份以 Markdown 为阅读与复制入口的 C++20 算法竞赛模板。全册含第 0–15 章，其中第 1–14 章共 668 个算法知识点，第 0 章为比赛检查清单，第 15 章为题面英文词表；代码、接口说明、复杂度和快速检查均收录在各章正文中，`include/` 保留可独立编译的实现，`tests/` 保留固定样例和随机对拍。
