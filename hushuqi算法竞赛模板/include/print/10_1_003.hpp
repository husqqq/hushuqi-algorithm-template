        ...
        while (len < h)
        {
            if (h - len == 1)
            {
                ...
                for (int s = 0; s < (1 << len); s++)
                {
                    ...
                    if (s + 1 != (1 << len))
                    {
                        rot = (unsigned long long)rot * rate2[countr_zero((unsigned long long)~s)] % mod;
                    }
                }
                len++;
            }
            else
            {
                ...
                for (int s = 0; s < (1 << len); s++)
                {
                    ...
                    if (s + 1 != (1 << len))
                    {
                        rot = (unsigned long long)rot * rate3[countr_zero((unsigned long long)~s)] % mod;
                    }
                }
                len += 2;
            }
        ...
        while (len)
        {
            if (len == 1)
            {
                ...
                for (int s = 0; s < (1 << (len - 1)); s++)
                {
                    ...
                    if (s + 1 != (1 << (len - 1)))
                    {
                        rot = (unsigned long long)rot * irate2[countr_zero((unsigned long long)~s)] % mod;
                    }
                }
                len--;
            }
            else
            {
                ...
                for (int s = 0; s < (1 << (len - 2)); s++)
                {
                    ...
                    if (s + 1 != (1 << (len - 2)))
                    {
                        rot = (unsigned long long)rot * irate3[countr_zero((unsigned long long)~s)] % mod;
                    }
                }
                len -= 2;
            }
