...
// Problem: consecutive_terms_of_linear_recurrent_sequence
#include <bits/stdc++.h>
using namespace std;
...
pair<fps, fps> divmod(fps f, fps g) {
    fps q = f / g, r = f - g * q;
 ...
 * @sa
 * https://maspypy.com/%E5%A4%9A%E9%A0%85%E5%BC%8F%E3%83%BB%E5%BD%A2%E5%BC%8F%E7%9A%84%E3%81%B9%E3%81%8D%E7%B4%9A%E6%95%B0%EF%BC%88%EF%BC%93%EF%BC%89%E7%B7%9A%E5%BD%A2%E6%BC%B8%E5%8C%96%E5%BC%8F%E3%81%A8%E5%BD%A2%E5%BC%8F#toc7
 ...
 */
vector<mint> bostan_mori(const fps& p, const fps& q, const uint64_t k, const size_t m) {
    ...
    auto rec = [d](auto rec, fps q, const uint64_t k) -> fps {
        ...
        // If you write "if (k <= d)", then the program will fall into an infinite loop for the test case
        // "example_01.in".
        if (k <= max<size_t>(1, d)) {
    ...
    // P_k/Q
    vector<mint> res = pk * fps_inv(q, m);
    res.resize(m);
    return res;
}

/**
 * @brief Computes [A_k, A_{k+1}, ..., A_{k+m-1}] from the first d terms [A_0, A_1, ..., A_{d-1}] and the linear
 * reccurrence A_i=Sum[j=0,d-1] A_{i-1-j} C_j  (i>=d)
 * @sa https://qiita.com/ryuhe1/items/da5acbcce4ac1911f47a
 * @sa https://qiita.com/ryuhe1/items/c18ddbb834eed724a42b
 * @sa
 * https://maspypy.com/%E5%A4%9A%E9%A0%85%E5%BC%8F%E3%83%BB%E5%BD%A2%E5%BC%8F%E7%9A%84%E3%81%B9%E3%81%8D%E7%B4%9A%E6%95%B0%EF%BC%88%EF%BC%93%EF%BC%89%E7%B7%9A%E5%BD%A2%E6%BC%B8%E5%8C%96%E5%BC%8F%E3%81%A8%E5%BD%A2%E5%BC%8F#toc7
 ...
 */
vector<mint> consecutive_terms_of_linear_reccurrent_sequence(const vector<mint>& a, const vector<mint>& c,
                                                             const uint64_t k, const size_t m) {
    /**
    ...
    r.erase(r.begin(), r.begin() + min<uint64_t>(r.size(), k));
    r.resize(m);
...
int main() {
    ...
    vector<mint> ans = consecutive_terms_of_linear_reccurrent_sequence(a, c, k, m);
    for (int i = 0; i < m; ++i) {
        ::printf("%d", ans[i].val());
        ::printf(i + 1 == m ? "\n" : " ");
    }
