#ifndef TEMPLATE_INLINE_302816D7F56CECCA7040
#define TEMPLATE_INLINE_302816D7F56CECCA7040
...
template <class T> void divisorZeta(vector<T>& a) {
    for (int divisor = a.size() - 1; divisor; --divisor) {
        for (int multiple = divisor * 2; multiple < a.size(); multiple += divisor) a[multiple] += a[divisor];
    }
}

template <class T> void divisorMobius(vector<T>& a) {
    for (int divisor = 1; divisor < a.size(); ++divisor) {
        for (int multiple = divisor * 2; multiple < a.size(); multiple += divisor) a[multiple] -= a[divisor];
    }
}
...
template <class T> void multipleZeta(vector<T>& a) {
    for (int divisor = 1; divisor < a.size(); ++divisor) {
        for (int multiple = divisor * 2; multiple < a.size(); multiple += divisor) a[divisor] += a[multiple];
    }
}

template <class T> void multipleMobius(vector<T>& a) {
    for (int divisor = a.size() - 1; divisor; --divisor) {
        for (int multiple = divisor * 2; multiple < a.size(); multiple += divisor) a[divisor] -= a[multiple];
    }
}
...
int main() {
    ...
    int n;
    cin >> n;
    vector<acl::ModInt998244353> a(n + 1), b(n + 1);
    for (int i = 1; i <= n; ++i) {
        int value;
        cin >> value;
        a[i] = value;
